...
(function(Opal) {
  ...
  var TMP_1, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, ans = nil;

  Opal.add_stubs(['$===', '$+', '$fib', '$-', '$puts']);
  Opal.defn(Opal.Object, '$fib', TMP_1 = function $$fib(n) {
    var self = this, $case = nil;

    return (function() {$case = n;if ((0)['$===']($case)) {return 0}else if ((1)['$===']($case)) {return 1}else {return $rb_plus(self.$fib($rb_minus(n, 2)), self.$fib($rb_minus(n, 1)))}})();
  }, TMP_1.$$arity = 1);
  var t0 = new Date();
  Opal.cdecl($scope, 'N', 28);
  ans = self.$fib($scope.get('N'));
  self.$puts("ans: " + (ans));
